#!/bin/bash
#
# Run signle version experiment in Docker
# Before running this script, run `docker login`
# Usage: single_experiment_in_docker.sh <projects-list> <output-dir> <traces-dir> [branch=false] [timeout=86400 (sec)]
#
...
function check_input() {
  if [[ ! -f ${PROJECTS_LIST} || -z ${OUTPUT_DIR} || ! -d ${TRACES_DIR} ]]; then
    echo "Usage: single_experiment_in_docker.sh <projects-list> <output-dir> <traces-dir> [branch=false] [timeout=86400 (sec)]"
    exit 1
  fi
...
function run_project() {
  ...
  echo "Running command: timeout ${TIMEOUT} bash single_version_experiment.sh -r ${repo} -s ${sha} -x ${SKIP_RUN} -m /home/tsm/tsm-matrix/tests-state-online_detour-prefix.csv -l /home/tsm/tsm-matrix/tests-perfect-location.csv -t /home/tsm/tsm-suite/reduced/reduced_tests-state-online_detour-prefix-greedy-none.txt /home/tsm/tsm/extensions /home/tsm/tsm/mop /home/tsm/tsm/output"
  timeout ${TIMEOUT} docker exec -w /home/tsm/tsm/scripts -e M2_HOME=/home/tsm/apache-maven -e MAVEN_HOME=/home/tsm/apache-maven -e CLASSPATH=/home/tsm/aspectj-1.9.7/lib/aspectjtools.jar:/home/tsm/aspectj-1.9.7/lib/aspectjrt.jar:/home/tsm/aspectj-1.9.7/lib/aspectjweaver.jar: -e PATH=/home/tsm/apache-maven/bin:/usr/lib/jvm/java-8-openjdk/bin:/home/tsm/aspectj-1.9.7/bin:/home/tsm/aspectj-1.9.7/lib/aspectjweaver.jar:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin ${id} timeout ${TIMEOUT} bash single_version_experiment.sh -r ${repo} -s ${sha} -x ${SKIP_RUN} -m /home/tsm/tsm-matrix/tests-state-online_detour-prefix.csv -l /home/tsm/tsm-matrix/tests-perfect-location.csv -t /home/tsm/tsm-suite/reduced/reduced_tests-state-online_detour-prefix-greedy-none.txt /home/tsm/tsm/extensions /home/tsm/tsm/mop /home/tsm/tsm/output &> ${OUTPUT_DIR}/${project_name}/docker.log
